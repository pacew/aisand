...
# aisand: implementation details

This document describes how `aisand` works and the choices behind it. For a higher-level introduction, see [README.md](README.md).
...
**What we accept:**
- Arbitrary command execution inside the container (you control what Claude suggests; pytest, builds, scripts, etc. are expected).
